...
if(isset($_POST['subm']))
{
    ...
    mysqli_query($conn,"INSERT INTO complaint_tb(date,complaint,post_number)VALUES('$date','$complaint','$post')");
                    ...
                    <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form method="POST" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="hf-email" class=" form-control-label">Complaint</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="hf-email" class=" form-control-label">Post Number</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="post" placeholder="post" class="form-control" required="">
                                                    <!-- <span class="help-block">Please enter your email</span> -->
                                                </div>
                                            </div>
